...
class IrLogging(models.Model):
    ...
    messenger_job_id = fields.Many2one("us.messenger.job", ondelete="cascade")
    messenger_task_id = fields.Many2one("us.messenger.task", related="messenger_job_id.task_id")
    project_id = fields.Many2one(
        "us.messenger.project", related="messenger_job_id.task_id.project_id"
    )
