...
class AdvancePaymentWizard(models.TransientModel):
    ...
    paid_amount = fields.Monetary(string="Amount")
    total_amount = fields.Monetary(string="Total Amount")
    amount_difference = fields.Monetary(string="Amount Difference")
    ...
    date = fields.Datetime(string="Payment Date", default=datetime.now())
